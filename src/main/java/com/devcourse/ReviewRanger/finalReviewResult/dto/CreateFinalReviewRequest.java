...
public record CreateFinalReviewRequest(
	...
	@Schema(name = "수신자 id", description = "수신자 id")
	@NotNull(message = "리뷰 대상 id는 빈값 일 수 없습니다.")
	Long userId,

	@Schema(name = "수신자 이름", description = "수신자 이름")
	@NotBlank(message = "리뷰 대상 이름은 빈값 일 수 없습니다.")
	String userName,

	@Schema(name = "리뷰 id", description = "리뷰 id")
	@NotNull(message = "리뷰 id는 빈값 일 수 없습니다.")
	Long reviewId,

	@Schema(name = "리뷰 제목", description = "리뷰 제목")
	@NotBlank(message = "리뷰 제목은 빈값 일 수 없습니다.")
	String reviewTitle,

	@Schema(name = "리뷰 설명", description = "리뷰 설명")
	String reviewDescription,

	@Schema(name = "해당 리뷰의 질문과 답변 리스트", description = "해당 리뷰의 질문과 답변 리스트")
